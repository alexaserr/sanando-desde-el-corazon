...
export function BlockageRow({
  ...
  const hasDictMatch = showTextFields && !!lookupMeaning(value.organ_name);
    ...
    {showTextFields && (
      <div className="flex flex-col gap-2 pl-[80px]">
        <div className="flex flex-col gap-1">
          ...
          {hasDictMatch || value.significado ? (
            <AutoResizeTextarea
            ...
            <div className="flex items-center gap-2 rounded bg-[#FAF7F5] px-3 py-2">
              <span className="text-sm text-gray-500 italic">
                Revisa el Diccionario de Sanando desde el Corazón para más información
              </span>
              <a
                href="https://www.sana-desde-el-corazon.com/diccionario-sintomas"
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 inline-flex items-center gap-1 rounded bg-terra-700 px-2.5 py-1 text-xs font-medium text-white hover:bg-terra-800 transition-colors"
              >
                Abrir diccionario
